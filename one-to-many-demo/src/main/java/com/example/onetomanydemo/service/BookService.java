...
public class BookService {
    ...
    public void newThreeBooksWithoutAuthor() {
        ...
        Book book2 = new Book("book arrow", 44, "Novel");
    ...
    public void addNewBookWithExistingAuthor() {
        ...
        Book book = new Book("Klara and Sun", 30, "Si-Fi");
        author.addBook(book);
    }
    ...
    public void saveAuthorWithThreeBooks() {
        ...
        Book book1 = new Book("A pale view of hill", 25.3, "Novel");
        Book book2 = new Book("Don't let me go", 30, "Novel");
        Book book3 = new Book("The remains of the day", 50, "Novel");
